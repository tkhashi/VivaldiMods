...
const l10n = {
    en_gb: {
        ...
        overwrite_prompt: 'Are you sure you want to overwrite $T?',
        overwrite_confirm: '⚠ Yes, Overwrite',
        overwrite_abscond: 'No, don\'t.',
    ...
    ja: {
        ...
        overwrite_prompt: '$T を上書きしますか？',
        overwrite_confirm: '⚠ 上書き',
        overwrite_abscond: 'キャンセル',
        ...
        sessions_lonm: {
            ...
            switch: `<span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="5 0 10 10">
                        <path fill-rule="evenodd" d="M7 2h6v1h-6v-1zm0 2h6v1h-6v-1zm0 2h6v1h-6v-1z"></path>
                    </svg>
                </span>`,
            initialHTML: `
                <div class="newSession">
                    <h2>${l10n.new_session}</h2>
                    <input type="text" placeholder="${l10n.session_name_placeholder}" class="session-name" id="new-session">
                ...
                <div class="overwrite-modal-container">
                    <div class="overwrite-confirm">
                        <p>${l10n.overwrite_prompt}</p>
                        <button class="yes">${l10n.overwrite_confirm}</button>
                        <button class="no">${l10n.overwrite_abscond}</button>
                    </div>
                </div>
                <template class="session_item">
                    <li class="sessionItem" tabindex="0">
                        <div>
                            <h3></h3>
            ...
            module: function(){
                ...
                /**
                 * Overwrite a session of selected item.
                */
                function listItemDoubleClick(e){
                    const selectedSession = e.currentTarget.classList.add("selected")
                    const overwrite_t = l10n.overwrite_prompt.replace('$T', selectedSession);
                    document.querySelector("#sessions_lonm .overwrite-modal-container").classList.add("show");
                    confirmMsg(overwrite_t);
                    console.log("listItemDoubleClick()")
                }
                ...
                function confirmMsg(msg){
                    ...
                    document.querySelector("#sessions_lonm .overwrite-confirm p").innerText = msg;
                }
                ...
                function overwriteConfirmClick(e){
                    ...
                    vivaldi.sessionsPrivate.delete(selections[selections.length-1], ()=>{});
                    document.querySelector("#sessions_lonm .overwrite-modal-container").classList.remove("show");
                 ...
                 * @param e event
                 */
                function overwriteCancelClick(e){
                    document.querySelector("#sessions_lonm .overwrite-modal-container").classList.remove("show");
                    document.querySelector("#sessions_lonm li.selected").classList.remove("selected");
                }
                ...
                function createListItem(session){
                    ...
                    el.querySelector("li").addEventListener("dblclick", listItemDoubleClick);
                ...
                function onInit(){
                    ...
                    document.querySelector("#sessions_lonm .overwrite-confirm .yes").addEventListener("click", overwriteConfirmClick);
                    document.querySelector("#sessions_lonm .overwrite-confirm .no").addEventListener("click", overwriteCancelClick);
